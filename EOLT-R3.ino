...
//================Hell Sensor readings Arrays=============
long uutVerbose[18]; //This is for storing the hall sensor reading for each hall this value is max heads * max halls or 3*6 = 18 
long uutPassFail[18][3]; //this stores the MAX and MIN and Differance for an entire test +900 steps, row 0 is MAX, 1 is MIN, 2 is Diff
...
void setup() {
  ...
  lcd.clear();
  // ====================Software Version====================
  String softwareVersion = "0.0.0.3"; // update this as the program changes
  String softwareDate = "11/27/2018"; // update this as the program changes
